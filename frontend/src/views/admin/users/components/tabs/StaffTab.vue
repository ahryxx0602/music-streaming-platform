...
<template>
 ...
 <button v-if="user.status === 'Active'" @click="changeStatus(user, 'Suspended')" class="p-1.5 text-theme-warning hover:bg-theme-warning/10 dark:hover:bg-amber-500/15 rounded-md transition" :title="$t('admin.users_page.action_suspend')"><IconLock size="18" /></button>
 <button v-else @click="changeStatus(user, 'Active')" class="p-1.5 text-theme-success hover:bg-theme-success/10 dark:hover:bg-theme-success/15 rounded-md transition" :title="$t('admin.users_page.action_activate')"><IconLockOpen size="18" /></button>
 <button v-if="user.status !== 'Banned'" @click="changeStatus(user, 'Banned')" class="p-1.5 text-theme-danger hover:bg-theme-danger/10 dark:hover:bg-rose-500/15 rounded-md transition" :title="$t('admin.users_page.action_ban')"><IconShield size="18" /></button>
 
 <button @click="openEdit(user)" class="p-1.5 text-admin-primary hover:bg-theme-info/10 dark:hover:bg-blue-500/15 rounded-md transition ml-1" :title="$t('admin.users_page.action_edit')"><IconEdit size="18" /></button>
 <button @click="deleteUser(user)" class="p-1.5 text-theme-danger hover:bg-theme-danger/10 dark:hover:bg-rose-500/15 rounded-md transition" :title="$t('admin.users_page.action_delete')"><IconTrash size="18" /></button>
 </div>
 </td>
 </tr>
 </template>
