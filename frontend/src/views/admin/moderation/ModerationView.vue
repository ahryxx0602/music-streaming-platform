...
<template>
 ...
 <div class="bg-theme-warning/10 border border-amber-100 px-4 py-2 rounded-xl flex items-center gap-3">
 <div class="w-8 h-8 bg-theme-warning/15 text-theme-warning rounded-full flex items-center justify-center font-bold">
