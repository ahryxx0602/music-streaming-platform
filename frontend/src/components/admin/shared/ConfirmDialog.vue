...
<template>
 ...
 <!-- Backdrop -->
 <div class="absolute inset-0 bg-theme-bg/80 backdrop-blur-sm" @click="!loading && $emit('update:modelValue', false)"></div>
 ...
 :class="{
 'bg-theme-danger/15 text-theme-danger ': type === 'danger',
 'bg-theme-warning/15 text-theme-warning ': type === 'warning',
 'bg-theme-info/15 text-theme-info ': type === 'info' || !type
 }"
 >
 ...
 :disabled="loading"
 class="flex-1 h-10 rounded-lg border border-theme-border font-semibold text-theme-text-sec hover:bg-theme-bg transition-colors disabled:opacity-50"
 >
 ...
 :class="{
 'bg-theme-danger hover:bg-theme-danger/80': type === 'danger',
 'bg-theme-warning hover:bg-theme-warning/80': type === 'warning',
 'bg-theme-info hover:bg-theme-info/80': type === 'info' || !type
 }"
 >
