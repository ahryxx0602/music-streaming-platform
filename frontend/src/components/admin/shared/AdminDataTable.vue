    ...
    <div v-if="total && perPage && total > perPage" class="px-6 py-4 border-t border-theme-border bg-theme-bg flex items-center justify-between">
      ...
      <div class="flex items-center gap-1">
        <button 
          ...
          class="px-3 py-1.5 border border-slate-300 rounded text-sm text-theme-text-sec bg-theme-surface hover:bg-theme-bg disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Trang trước
        </button>
        <button 
