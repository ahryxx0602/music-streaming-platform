...
<template>
 ...
 >
 <div class="space-y-4">
 <div class="flex items-start gap-3 p-3 bg-theme-warning/10 text-amber-800 rounded-lg text-sm border border-theme-warning/20/50">
 ...
 class="w-full p-3 bg-theme-surface border border-theme-border rounded-xl text-sm focus:ring-2 focus:ring-rose-500 focus:border-rose-500 outline-none resize-none transition-all shadow-[var(--shadow-glow)]"
 ></textarea>
 </div>
 ...
 class="flex items-center gap-2 px-4 py-2 bg-rose-500 text-white rounded-lg font-medium hover:bg-rose-600 disabled:opacity-50 disabled:hover:bg-rose-500 transition-colors shadow-[var(--shadow-glow)] shadow-rose-500/20"
 >
 <IconSend size="16" />
