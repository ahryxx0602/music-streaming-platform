...
<template>
 ...
 :class="listenerData.is_premium ? 'bg-theme-warning/10 border-theme-warning/20' : 'bg-theme-bg border-theme-border'">
 <div class="w-10 h-10 rounded-full flex items-center justify-center shrink-0"
 :class="listenerData.is_premium ? 'bg-theme-warning/15 text-theme-warning ' : 'bg-slate-200 text-theme-text-sec'">
 <IconCrown size="20" />
 </div>
 <div>
 ...
 <p class="text-xs mt-1" :class="listenerData.is_premium ? 'text-theme-warning/80' : 'text-theme-text-sec'">
