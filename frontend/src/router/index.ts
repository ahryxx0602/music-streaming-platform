  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'albums/create',
          name: 'artist-albums-create',
          component: () => import('../views/artist/album/CreateAlbumView.vue'),
        },
        {
          path: 'albums/:id',
          name: 'artist-albums-detail',
          component: () => import('../views/artist/album/AlbumDetailView.vue'),
        }
      ]
    }
  ],
