...
directories = [
    'frontend/src/views/admin/invites',
    'frontend/src/components/admin/features/invites',
    'frontend/src/views/admin/inventory',
    'frontend/src/components/admin/features/inventory',
    'frontend/src/views/admin/moderation',
    'frontend/src/components/admin/features/moderation',
    'frontend/src/views/admin/banners',
    'frontend/src/components/admin/features/banners',
]
...
replacements = {
    ...
    # Also strip any hardcoded dark: classes since our theme CSS uses CSS variables natively
    r'\bdark:bg-\[?[^ ]+\]?\b': '',
    r'\bdark:text-[^ ]+\b': '',
    r'\bdark:border-[^ ]+\b': '',
    r'\bdark:hover:bg-[^ ]+\b': '',
...
def process_file(filepath):
    ...
    # clean up multiple spaces that might have been left by stripping dark: classes
